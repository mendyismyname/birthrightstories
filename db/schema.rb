...
ActiveRecord::Schema.define(version: 20140909205654) do
  ...
  # add_index "active_admin_comments", ["author_type", "author_id"], name: "on_author_type_and_author_id", using: :btree
  # add_index "active_admin_comments", ["namespace"], name: "on_namespace", using: :btree
  # add_index "active_admin_comments", ["resource_type", "resource_id"], name: "on_resource_type_and_resource_id", using: :btree
